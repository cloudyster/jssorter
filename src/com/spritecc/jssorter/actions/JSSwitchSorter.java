...
public class JSSwitchSorter extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        for (int i = startLine + 1; i < lines.length; ++i) {
            ...
            if (trimLine.startsWith("case") || trimLine.startsWith("default")) {
                ...
                if (!cases.containsKey(caseLine)) {
                    cases.put(caseLine, new LinkedList<String>());
                }
            }
            if (!caseLine.isEmpty()) {
                cases.get(caseLine).add(lines[i]);
            }
        }
        ...
        DocumentUtil.replaceWithText(project, document, sortedCases, startLine + 1, switchEndLine - 1, "Sort switch cases");
    }
