...
public class JSImportSorter extends AnAction {
	private final Comparator<String> IGNORE_OPEN_CURLY_STRING_COMPARATOR = (o1, o2) -> {
	...
	public void update(AnActionEvent e) {
		...
		presentation.setEnabled(
				(file != null) && ("js".equals(file.getExtension()) || "jsx".equals(file.getExtension())));
	}
	...
	String sortItemsInMultipleImport(final String line) {
		...
		final String[] items = line.substring(openCurly + 1, closeCurly)
				.split(",");
	...
	private void replaceWithSortedImports(final Project project, final Document document) {
		...
		final Runnable runner = () -> document.replaceString(importStartOffset, importEndOffset, sortedImports);

		ApplicationManager.getApplication()
				.invokeLater(() -> CommandProcessor.getInstance()
						.executeCommand(project, () -> ApplicationManager.getApplication()
								.runWriteAction(runner), "Sort JS Imports", null));
	}
